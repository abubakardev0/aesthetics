    ...
    return (
        <>
            <div className="space-y-1">
                ...
                <input
                    type="text"
                    className="w-full rounded-xl border-[2px] border-gray-300 p-2 capitalize transition-transform delay-75 duration-300 placeholder:text-sm hover:border-black focus:-translate-y-[2px] focus:border-black md:border-[3px]"
            ...
            <div className="space-y-1">
                ...
                <div className="relative mb-6 flex w-full space-x-2 rounded-xl border-[2px] border-gray-300 p-2 capitalize transition-transform delay-75 duration-300 hover:border-black active:-translate-y-[2px] active:border-black md:border-[3px]">
                    <span>+92</span>
                    <input
            ...
            <div>
                ...
                <select
                    id="province"
                    name="province"
                    className="w-full rounded-xl border-[2px] border-gray-300 p-2 transition-transform delay-75 duration-300 placeholder:text-sm hover:border-black focus:-translate-y-[2px] focus:border-black md:border-[3px]"
                    required
                    {...register('province', {
                        required: true,
                    })}
